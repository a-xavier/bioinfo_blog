  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {
          type: 'docSidebar',
          sidebarId: 'genomicsSidebar',
          docsPluginId: 'genomics',
          position: 'left',
          label: 'Genomics',
        },
        {
          type: 'docSidebar',
          sidebarId: 'proteomicsSidebar',
          docsPluginId: 'proteomics',
          position: 'left',
          label: 'Proteomics',
        },
          {
